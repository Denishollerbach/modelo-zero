...
<main id="content" class="pagina-politica-cookies">
     ...
     <section class="container" id="termosEpoliticas">
          <article class="row">
               <div class="col-12">
                    <p>
                    ...
                    <ul>
                         ...
                         <li>• <a href="https://support.google.com/accounts/answer/61416?co=GENIE.Platform%3DDesktop&amp;hl=pt-BR" target="_blank" rel="noopener noreferrer">Google Chrome</a></li>
                         <li>• <a href="https://support.apple.com/pt-br/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer">Safari</a></li>
                         <li>• <a href="https://support.microsoft.com/pt-br/help/4468242/microsoft-edge-browsing-data-and-privacy-microsoft-privacy" target="_blank" rel="noopener noreferrer">Microsoft Edge</a></li>
                    </ul>
                    ...
                    <p>Se Você tiver dúvidas sobre qualquer disposição constante nesta Política de Cookies ou quiser fazer alguma
                         solicitação, entre em contato conosco através do <a href="/contato">formulário de contato</a></p>
